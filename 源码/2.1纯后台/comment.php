...
<body>
	...
	<div class="hd main">
	<div class="left hd1">
	<center><a href="../index.php" target="_blank">陕西科技大学校运会</a></div>	</center>
	<div class="right hd2">
	...
	//获取旧的信息
	if(firstid>0){
	$(".list").after("<a href='#' id='listold' class='listold'>获取更多留言</a>");	
	...
	<a href="#" class="bd121">Leave</a><a href="#" class="login right">设定昵称</a>用文字留下你的声音。
	</div>
	<div class="msg">
	<div class="msg1">一起加油助威</div>
	<div class="msg1">青春风采</div>	
	<div class="msg1">运动健身</div>	
	<div class="msg1">拼搏、毅力</div>	
	<div class="msg1">正在为你加载留言</div>	
	</div>
	<div class="list">
	...
	<div class="ft main" id="end">
	<center><div class="left ft1" align="right"> © 点心网络文化工作室 </div></center>
	<div class="right ft2">
